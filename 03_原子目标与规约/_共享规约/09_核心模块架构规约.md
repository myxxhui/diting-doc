...
- **仍施加**：逻辑证伪止损（产业趋势或基本面逻辑被证伪时止损）、大周期反转止盈（Major Trend Reversal 时止盈）。具体条件见 L1 [03_双轨制与VC-Agent](../../01_顶层概念/03_双轨制与VC-Agent.md) 或下游规约。
