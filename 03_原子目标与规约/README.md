...
| <a id="l3-dna-08b"></a>l3-dna-08b | `12_右脑数据支撑与Segment规约.md`（文档标题：右脑数据支撑与细分规约） | `data_ingestion`（与 11_ 共用）、步骤级 Stage2-02/Stage3-01/Stage3-04 | 标的主营构成表、细分注册表与一手信号按需拉取、Module A/C 输入扩展；供 C 右脑「利好与主营对齐」判断 |
