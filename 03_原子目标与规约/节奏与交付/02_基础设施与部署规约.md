...
> - **战略维度**: [01_八个月开发与交付节奏](../../02_战略维度/节奏与交付/01_八个月开发与交付节奏.md)、[03_数据体系与分层存储](../../02_战略维度/平台与产品/03_数据体系与分层存储.md)
...
本节约定 diting-src 及采集/模块镜像的运行时与依赖，与 [01_顶层概念/05_当前阶段优先开源选型](../../02_战略维度/技术选型与调研/02_当前阶段优先开源选型.md) 及 L3 各阶段设计「依赖与构建」、DNA `integration_packages` 一致。
...
- **引用**：[02_三位一体仓库规约](../_共享规约/02_三位一体仓库规约.md)（repo_a）、[01_开发生命周期与实践流程规约](01_开发生命周期与实践流程规约.md)（阶段 3 部署验收）、[05_安全隔离与机密治理](../../02_战略维度/平台与产品/05_安全隔离与机密治理.md)、[05_当前阶段优先开源选型](../../02_战略维度/技术选型与调研/02_当前阶段优先开源选型.md)。
