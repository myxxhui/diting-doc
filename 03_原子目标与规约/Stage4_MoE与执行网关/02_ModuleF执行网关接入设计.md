...
本小节与 [Stage3-06 Module F 设计](../Stage3_模块实践/06_ModuleF设计.md#design-stage3-06-integration-vnpy) 中「逻辑填充期开源接入点：Vn.py」互补：Stage3-06 侧重接口形态与占位实现，本步侧重**实盘或仿真接入**与 E→F 验证。
...
- **依赖与构建**：执行网关镜像的依赖与 [Stage3-06 Module F 设计](../Stage3_模块实践/06_ModuleF设计.md#design-stage3-06-integration-vnpy) 中「依赖与构建」一致，确保占位/仿真或实盘适配器在镜像内可运行。
