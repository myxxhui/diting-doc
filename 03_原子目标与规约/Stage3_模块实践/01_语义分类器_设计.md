...
> - **L4 实践**: [01_语义分类器_实践](../../04_阶段规划与实践/Stage3_模块实践/01_语义分类器_实践.md#l4-stage3-01-exit)
...
- **输出**：Domain Tag、置信度分数 (0.0–1.0)；**须写入 L2 或共享存储**（表 `classifier_output_snapshot` 或约定协议），供 Module B 按约定读取，见 [01_语义分类器_实践·上部分·数据流与 L2 规约](../../04_阶段规划与实践/Stage3_模块实践/01_语义分类器_实践.md#l4-stage3-01-part1-dataflow)。
