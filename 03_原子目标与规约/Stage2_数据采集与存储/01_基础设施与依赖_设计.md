...
> - **DNA**: [_System_DNA/Stage2_数据采集与存储/dna_stage2_01_基础设施与依赖.yaml](../_System_DNA/Stage2_数据采集与存储/dna_stage2_01_基础设施与依赖.yaml)
> - **L4 实践**: [04_阶段规划与实践/Stage2_数据采集与存储/01_基础设施与依赖实践](../../04_阶段规划与实践/Stage2_数据采集与存储/01_基础设施与依赖实践.md#l4-stage2-01-exit)
...
| 类别 | 约定 | 权威来源 |
|------|------|----------|
| **Helm Chart** | 所有 Chart 须下载到本地 `charts/dependencies/<chart-name>/`；`Chart.yaml` 中 version 固定 | [dna_stage2_01_基础设施与依赖.yaml](../_System_DNA/Stage2_数据采集与存储/dna_stage2_01_基础设施与依赖.yaml) 的 `pinned_versions.charts` |
