...
> - **原子规约**: [核心模块架构规约](../03_原子目标与规约/09_核心模块架构规约.md)
...
**验收阈值**：涉及「CI/CD」「每次提交」的验收，**当前实施方式**见 [03_架构设计共识与协作元规则](../../03_原子目标与规约/03_架构设计共识与协作元规则.md) 中的「当前实施状态」。
...
**验收阈值**：同上，涉及 CI/CD/每次提交 的当前实施方式见 [03_架构设计共识与协作元规则](../../03_原子目标与规约/03_架构设计共识与协作元规则.md) 中的「当前实施状态」。
