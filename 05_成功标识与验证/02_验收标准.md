...
| <a id="l5-stage-stage2_01"></a>l5-stage-stage2_01 | stage2_01 | 基础设施与依赖部署 | 工程：TimescaleDB/Redis/PostgreSQL 可用；Schema init Job 成功；Chart/中间件版本固定并缓存；**下游可添加连接配置并调用表数据（V7）**。验证项 V1～V7 全部符合方准出，见 [01_基础设施与依赖部署#验证与准出](../../04_阶段规划与实践/Stage2_数据采集与存储/01_基础设施与依赖部署.md#l4-stage2-01-exit) | 消耗：Stage1-04 准出；产出：基础组件 Chart、Schema init、下游连接示例验证通过 |
| <a id="l5-stage-stage2_02"></a>l5-stage-stage2_02 | stage2_02 | 采集逻辑与Dockerfile | 工程：采集逻辑实现；make ingest-test 可运行；**依赖与构建**：见 [L3 设计#design-stage2-02-deps](../03_原子目标与规约/Stage2_数据采集与存储/02_采集逻辑与Dockerfile设计.md#design-stage2-02-deps) 与 L4 验证（镜像内 make ingest-test） | 消耗：Stage2-01 准出；产出：采集任务、Dockerfile |
...
| <a id="l5-stage-stage3_02"></a>l5-stage-stage3_02 | stage3_02 | Module B 量化扫描引擎 | 功能：同 l5-mod-B；四项 100%；**依赖与构建**：见 [L3 设计#design-stage3-02-deps](../03_原子目标与规约/Stage3_模块实践/02_ModuleB设计.md#design-stage3-02-deps) 与 L4 验证（镜像内 make test） | 消耗：Stage3-01 准出；产出：Module B 实现 |
...
| <a id="l5-stage-stage3_04"></a>l5-stage-stage3_04 | stage3_04 | Module D 判官 | 功能：同 l5-mod-D；四项 100%；**依赖与构建**：见 [L3 设计 PyPortfolioOpt 依赖与构建](../03_原子目标与规约/Stage3_模块实践/04_ModuleD设计.md#design-stage3-04-integration-pfo) 与 L4 验证（镜像内判官单测） | 消耗：Stage3-03 准出；产出：Module D 实现 |
| <a id="l5-stage-stage3_05"></a>l5-stage-stage3_05 | stage3_05 | Module E 风控盾 | 功能：同 l5-mod-E；四项 100% | 消耗：Stage3-04 准出；产出：Module E 实现 |
| <a id="l5-stage-stage3_06"></a>l5-stage-stage3_06 | stage3_06 | Module F 执行网关 | 功能：同 l5-mod-F；四项 100%；全链路 A→F；**依赖与构建**：见 [L3 设计 Vn.py 依赖与构建](../03_原子目标与规约/Stage3_模块实践/06_ModuleF设计.md#design-stage3-06-integration-vnpy) 与 L4 验证（镜像内 place_order 单测） | 消耗：Stage3-05 准出；产出：Module F 实现 |
...
| <a id="l5-stage-stage4_02"></a>l5-stage-stage4_02 | stage4_02 | Module F 执行网关接入 | 功能：同 l5-func-06；E→F 衔接；**依赖与构建**：与 Stage3-06 一致，见 [L3 设计](../03_原子目标与规约/Stage4_MoE与执行网关/02_ModuleF执行网关接入设计.md#design-stage4-02-vnpy) 与 L4 验证 | 消耗：Stage4-01 准出；产出：执行网关接入 |
...
|------|----------|--------------------------|
| [l5-stage-stage2_02](#l5-stage-stage2_02) | stage2_02 | [Stage2-02 采集逻辑与Dockerfile设计](../03_原子目标与规约/Stage2_数据采集与存储/02_采集逻辑与Dockerfile设计.md#design-stage2-02-integration-akshare)（AkShare、OpenBB） |
| [l5-stage-stage3_01](#l5-stage-stage3_01) | stage3_01 | Module A 消费 11_/Stage2-02 采集输出；输入可获取见 [11_](../03_原子目标与规约/_共享规约/11_数据采集与输入层规约.md) 与 [Stage2-02](../03_原子目标与规约/Stage2_数据采集与存储/02_采集逻辑与Dockerfile设计.md) |
| [l5-stage-stage3_02](#l5-stage-stage3_02) | stage3_02 | [Stage3-02 ModuleB设计](../03_原子目标与规约/Stage3_模块实践/02_ModuleB设计.md#design-stage3-02-integration-talib)（TA-Lib、Qlib、VectorBT、Alphalens） |
| [l5-stage-stage3_04](#l5-stage-stage3_04) | stage3_04 | [Stage3-04 ModuleD设计](../03_原子目标与规约/Stage3_模块实践/04_ModuleD设计.md#design-stage3-04-integration-pfo)（PyPortfolioOpt） |
| [l5-stage-stage3_06](#l5-stage-stage3_06) | stage3_06 | [Stage3-06 ModuleF设计](../03_原子目标与规约/Stage3_模块实践/06_ModuleF设计.md#design-stage3-06-integration-vnpy)（Vn.py） |
| [l5-stage-stage4_02](#l5-stage-stage4_02) | stage4_02 | [Stage4-02 ModuleF执行网关接入设计](../03_原子目标与规约/Stage4_MoE与执行网关/02_ModuleF执行网关接入设计.md#design-stage4-02-vnpy)（Vn.py 对接要点） |
| [l5-stage-stage4_03](#l5-stage-stage4_03) | stage4_03 | [Stage4-03 回测或仿真验证设计](../03_原子目标与规约/Stage4_MoE与执行网关/03_回测或仿真验证设计.md#design-stage4-03-integration-lean)（Lean 四层解耦与仿真度） |
