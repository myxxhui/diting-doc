...
> - **原子能力**: [09_核心模块架构规约](../../03_原子目标与规约/09_核心模块架构规约.md)（Module C）、[01_核心公式与MoE架构规约](../../03_原子目标与规约/01_核心公式与MoE架构规约.md)
...
1. [Phase1_核心链路](../Phase1_核心链路/README.md) 已完成（A/B/D/E 最小闭环）。
2. [Stage1](../00_交付流程步骤/Stage1_逻辑填充期/README.md) 或 [Stage1b](../00_交付流程步骤/Stage1b_Mock数据验证准出/README.md) 准出，工作目录 **diting-core** 可编译/可测。
3. [09_](../../03_原子目标与规约/09_核心模块架构规约.md) Module C、Router 与 ExpertOpinion 已定稿。
...
请先阅读 [09_核心模块架构规约](../../03_原子目标与规约/09_核心模块架构规约.md) Module C、本步骤「实施内容」。任务：1. 实现 MoE Router（按 Tag 分发，UNKNOWN→Trash Bin）；2. 至少一个专家接口或占位，输出 ExpertOpinion 与 D 契约一致；3. C→D Alpha 链路可跑通；4. 单测/集成通过。工作目录 diting-core。请输出：变更文件列表、关键类型摘录、单测命令与结果摘要。
...
1. [09_核心模块架构规约](../../03_原子目标与规约/09_核心模块架构规约.md) Module C
2. 本步骤「实施内容」「验收与测试」

## 依赖的 Stage

- 依赖 [Stage1_逻辑填充期](../00_交付流程步骤/Stage1_逻辑填充期/README.md)（s1）或 [Stage1b_Mock数据验证准出](../00_交付流程步骤/Stage1b_Mock数据验证准出/README.md)（s1b）准出。
- **前置 Phase**：[Phase1_核心链路](../Phase1_核心链路/README.md) 已完成（A/B/D/E 最小闭环）。
...
- [ ] 已更新 L5 [02_验收标准](../../05_成功标识与验证/02_验收标准.md) 中**功能验收表**「09_ Module C」一行（状态与验证方式）
...
- **本步依赖**：依赖 [Stage1_逻辑填充期](../00_交付流程步骤/Stage1_逻辑填充期/README.md)（s1）或 [Stage1b](../00_交付流程步骤/Stage1b_Mock数据验证准出/README.md)（s1b）准出；依赖 Phase1 全步骤准出。
