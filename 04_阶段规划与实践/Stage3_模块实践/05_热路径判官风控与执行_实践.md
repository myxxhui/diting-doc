...
> - **本步设计文档**: [05_热路径判官风控与执行_设计](../../03_原子目标与规约/Stage3_模块实践/05_热路径判官风控与执行_设计.md#design-stage3-05-exit)
...
**逻辑填充期接入点**：PyPortfolioOpt（判官）、Vn.py（执行），见设计文档 [design-stage3-05-integration-pfo](../../03_原子目标与规约/Stage3_模块实践/05_热路径判官风控与执行_设计.md#design-stage3-05-integration-pfo)、[design-stage3-05-integration-vnpy](../../03_原子目标与规约/Stage3_模块实践/05_热路径判官风控与执行_设计.md#design-stage3-05-integration-vnpy)。

<a id="l4-step-nav"></a>
## 步骤导航
- **上一步**：[04_MoE议会_实践](04_MoE议会_实践.md#l4-stage3-04-goal)
- **下一步**：[06_全链路验证_实践](06_全链路验证_实践.md#l4-stage3-06-goal)
...
```
你是在 diting-core 中实现热路径（判官+风控+执行）的开发者。必读：09_核心模块架构规约（Module D/E/F）、01_核心公式与MoE架构规约、05_接口抽象层规约、core_modules/dna_module_d/e/f.yaml、05_热路径判官风控与执行_设计.md。
