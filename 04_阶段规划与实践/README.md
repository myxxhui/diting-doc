...
**B 轨专项实践**（与 A 轨同列各 Stage，命名区分）：Stage2 [01_B轨_数据与采集_实践](Stage2_数据采集与存储/01_B轨_数据与采集_实践.md)、Stage3 [01_B轨_语义与候选_实践](Stage3_模块实践/01_B轨_语义与候选_实践.md)、Stage4 [01_B轨_共识与执行_实践](Stage4_MoE与执行网关/01_B轨_共识与执行_实践.md)；设计见 [03_/B轨/](../03_原子目标与规约/B轨/README.md)。
