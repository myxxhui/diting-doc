...
<a id="l4-step-nav"></a>
## 步骤导航
- **上一步**：[03_回测或仿真验证](../Stage4_MoE与执行网关/03_回测或仿真验证.md#l4-stage4-03-goal)
- **下一步**：[02_成本治理与Token熔断](02_成本治理与Token熔断.md#l4-stage5-02-goal)
...
- **本步准出即 Stage s3 准出条件之一**；本步验收命令纳入 [Stage3_模块实践 01_](../Stage3_模块实践/01_ModuleA.md#l4-stage3-01-exit)、[Stage4_MoE与执行网关 01_](../Stage4_MoE与执行网关/01_ModuleC_MoE议会接入.md#l4-stage4-01-exit) 可执行验证清单。
